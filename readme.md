---
title: "zIPC — 跨平台同机进程通信库 / High-Performance IPC Library"
description: "zIPC 是一个基于共享内存 + 消息队列的跨平台 IPC 库，提供纯 C ABI，支持 C++、Python、Go、Rust、Java、C#、Pascal 等语言，同机延迟 < 1ms。已被 LingoFuse 生产验证 18+ 个月，日调用峰值 5000 万+。"
keywords:
  - "ipc"
...
tags:
  ...
  - zero-copy
  - production
repo: "https://github.com/PassByYou888/zIPC"
related:
  - "https://github.com/PassByYou888/LingoFuse"
version: "v1.2.0"
